...
//            moveDistance(0.4, 700);
        ...
        if (leftvaluedetect == 0) {
            drive.followTrajectorySync(
                    drive.trajectoryBuilder()
                            .lineTo(new Vector2d(poseEstimate.getX(), poseEstimate.getY()-17))
                            .build());
        }
        // skystone position middle
        else if (midvaluedetect == 0) {
            drive.followTrajectorySync(
                    drive.trajectoryBuilder()
                            .lineTo(new Vector2d(poseEstimate.getX(), poseEstimate.getY()-27))
                            .build());
        }
        // skystone position right
        else if (rightvaluedetect == 0) {
        ...
        // open the claw to get second skystone
        sideClawOpen();
        ...
        drive.followTrajectorySync(
                drive.trajectoryBuilder()
                        .reverse()
                        .lineTo(new Vector2d(poseEstimate.getX(), poseEstimate.getY()+135))
                        .build());
         ...
         *
         *
         *  FROM SKYSTONE AUTO RED but modified for roadrunner
         *
         *
         *
         *
