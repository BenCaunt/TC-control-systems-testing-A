 ...
 */
@Autonomous
public class StoneNparkBlueSINGLE extends LinearOpMode {
...
//            moveDistance(0.4, 700);
        ...
        if (leftvaluedetect == 0) {
            // turn to left stone
            encoderStrafe(DRIVE_SPEED,13,-13,5);
        ...
        encoderDriveIMU(DRIVE_SPEED,8.5,8.5,5);
        // close claw down - grab first stone
        closeClaw();
         ...
         */
        // turn towards skybridge
        encoderDrive(TURN_SPEED-0.1, -17, 17, 5);


        // sprint straight across bridge
        if (midvaluedetect == 0) {
            encoderDriveIMU(1,39,39,5);
        }

        if (leftvaluedetect == 0) {
            encoderDriveIMU(1,47,47,5);
        }

        if (rightvaluedetect == 0) {
            encoderDriveIMU(1,34,34,5);
        ...
        encoderDriveIMU(DRIVE_SPEED,-15,-15,5);
        // strafe against skybridge
         encoderStrafe(1,5,-5,5);
