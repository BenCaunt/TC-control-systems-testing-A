...
public class DriveConstants {
    ...
    public static double VELO_P = 1;
    public static double VELO_i = 0;
    public static double VELO_d = 0;

    public static final PIDCoefficients MOTOR_VELO_PID = null;//new PIDCoefficients(VELO_P,VELO_i,VELO_d);
    ...
    // for solaris
    public static double GEAR_RATIO = 45/35;
    // for squirt
